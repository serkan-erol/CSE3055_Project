...
public interface IFinancialTransactionRepository
{
    ...
    Task<IReadOnlyList<FTResponseToEmployeeDto>> GetFTByCustomerIdForEmployeeAsync(int customerId, CancellationToken cancellationToken = default);
    ...
    Task<FTResponseToEmployeeDto> UpdateFTDescriptionAsync(UpdateFTDescriptionDto dto, CancellationToken cancellationToken = default);
